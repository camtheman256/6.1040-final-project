 ...
 */
const isValidGetPlaceRequestQuery = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
 ...
 */
const isValidCreateRequestPayload = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const isRequestAuthor = async (
  ...
  const placeRequest = await PlaceRequestCollection.findOneById(
